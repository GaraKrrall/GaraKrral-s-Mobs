...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    private void blockItem(DeferredBlock<?> block) {
        simpleBlockItem(block.get(), new ModelFile.UncheckedModelFile("garakrrals_mobs:block/" + block.getId().getPath()));
    }

    private void blockItem(DeferredBlock<?> block, String a) {
        simpleBlockItem(block.get(), new ModelFile.UncheckedModelFile("garakrrals_mobs:block/" + block.getId().getPath() + a));
    }
}