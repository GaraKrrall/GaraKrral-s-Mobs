...
public class GeckoEntity extends Animal {
    ...
    @Override
    public boolean isFood(ItemStack gara) {
        return gara.is(ModItems.TEST_ITEM);
    }

    @Override
    public @Nullable AgeableMob getBreedOffspring(ServerLevel xLevel, AgeableMob ageableMob) {
        return ModEntities.GECKO.get().create(xLevel);
    }
